            ...
            <div className="col-lg-6">
              ...
              <div>
                ...
                <div className="payment">
                  ...
                  <div className="d-flex justify-content-center">
                    <div
                      className="d-flex radio-wrapper justify-content-center"
                      style={{
                    ...
                    >
                      <div className="text-center">
                        ...
                        <p className="mb-0" style={{ color: "#FF8A00" }}>
                          {parentEmail}
                        </p>
                      </div>
                    </div>
                        ...
                        >
                          <div className="d-flex">
                            <img
                              ...
                              src={courseDetails.picture || demo}
                              alt=""
                            />
                            <div>
            ...
            <div className="col-lg-6">
              ...
              <div className="payment">
                <div style={{ padding: "10px 35px" }}>
                  <div
                    className="d-flex radio-wrapper justify-content-between"
