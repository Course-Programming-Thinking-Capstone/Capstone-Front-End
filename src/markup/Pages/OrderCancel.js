...
export default function OrderCancel() {
  ...
  const cancelOrder = async () => {
    ...
    try {
      const response = await instance.post(`api/v1/orders/request-cancel`, {
            ...
            <div className="order-cancel">
              <div className="d-flex justify-content-between">
                ...
                >
                  ...
                  <option value="Muốn thay đổi hình thức thanh toán">
                    Muốn thay đổi hình thức thanh toán
                  </option>
                  <option value="Muốn thay đổi thông tin trẻ">
                    Muốn thay đổi thông tin trẻ
                  </option>
                  <option value="Muốn mua khóa học khác">
                    Muốn mua khóa học khác
                  </option>
                  <option value="Chưa áp dụng voucher giảm giá">
                    Chưa áp dụng voucher giảm giá
                  </option>
                  <option value="Thay đổi ý, không mua nữa">
                    Thay đổi ý, không mua nữa
                  </option>
                </select>
              </div>
              <div
              ...
              >
                ...
                <div className="payment-method d-flex mt-3">
                  <img
                    style={{ width: "50px", height: "50px", marginBottom: 30 }}
                    src={momo}
                    alt="momo"
              ...
              <div className="col-lg-6 col-md-12 col-sm-12">
                <div className="order-policy-content">
                  ...
                  <div className="order-policy-stripe">
                    <p>
                      1. Chúng tôi sẽ không thể khôi phục lại đơn hàng đã hủy.
                    </p>
                    <p>
                      2. Yêu cầu hủy đơn sẽ được quản lý xét duyệt trong vòng 30
                      phút.
                    </p>
                    <p>
                      3. Kết quả xét duyệt sẽ được gửi về thông báo trong hộp
                      thư.
                    </p>
                    <p>
                      4. Nếu đơn hàng được xác nhận hủy thành công, tiền sẽ
                      hoàng về ví điện tử mà khách hàng đã thanh toán trong
                      khoảng 3-5 ngày.
                    </p>
                    <p>
                      5. Mỗi khách hàng chỉ được phép hủy đơn hàng 3 lần/tháng.
                    </p>
                  </div>
                  <div className="d-flex justify-content-start checked">
                    {policyChecked ? (
                      <i
                        ...
                        style={{ color: "#FF8A00", fontSize: "30px" }}
                        onClick={togglePolicyChecked}
                      ></i>
                    ) : (
                      <i
                    ...
                    <p className="mb">
                      Tôi đã hiểu và đồng ý với chính sách hủy của KidsPro
                    </p>
                  </div>
                  <div className="d-flex justify-content-end">
                    <button
                      onClick={handleShow}
                      className={
                        policyChecked ? "button-enabled" : "button-disabled"
                      }
                    >
                      CANCEL ORDER
                    </button>
