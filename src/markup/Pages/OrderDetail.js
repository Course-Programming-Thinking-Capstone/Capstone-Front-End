            ...
            <div className="container">
                <div className='order-item'>
                    <div className="header d-flex justify-content-between">
                        ...
                        <span style={{ backgroundColor: '#FF8A00' }}>Pending</span>
                    </div>
                        ...
                        <div className='order-select-content'>
                            ...
                            <div className='d-flex justify-content-center'>
                                <div className='d-flex justify-content-center' style={{ width: '60%', border: '1px solid #1A9CB7', borderRadius: '5px', padding: '5px 0', }}>
                                    ...
                                    <p style={{ marginLeft: '5px' }} className='mb'>anvip321@gmail.com</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    return (
        <div>
            ...
            <div style={{
                ...
                {orderDetails ? renderOrderDetail() : <div class="spinner-border text-primary" role="status">
