        ...
        {orderDetails ? (
          <div className="container">
            <div className="thanks text-center">
              <p style={{ fontSize: "32px", color: "#ff8a00" }}>
                <i class="fa-solid fa-circle-check"></i> Thank you for your
                purchase
              </p>
              ...
              <p style={{ fontSize: "20px", fontWeight: "400" }}>
                Your order code <span>{orderDetails.orderCode}</span>
              </p>
            </div>
            ...
            <div className="thanks-info">
              <div className="thanks-info-content">
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      <span style={{ color: "#FF8A00" }}>
                        {orderDetails.quantityPurchased}
                      </span>
                    </p>
                  </div>
                  <div>
                ...
                <div className="d-flex justify-content-between">
                  <p style={{ marginBottom: "6px" }}>
                    For more details about your order, please visit{" "}
                    <span>Order</span> on the menu
                  </p>
                  <button
                    onClick={ViewOrder}
                    style={{
              ...
              <div className="thanks-info-contact d-flex justify-content-start">
                ...
                <p>
                  Child’s account will send to email{" "}
                  <span>Long88ka@gmail.com</span>
                </p>
              </div>
            </div>
            ...
            <div className="d-flex justify-content-center">
              ...
              >
                Continue purchasing the course
              </button>
            </div>
          </div>
        ) : (
